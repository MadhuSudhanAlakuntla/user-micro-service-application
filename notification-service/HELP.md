...
* The original package name 'com.microservices-app.notification-service' is invalid and this project uses 'com.microservices_app.notification_service' instead.
